...
const Scratch3TxtBlocks = require('../extensions/scratch3_ftrobotxt');
const Scratch3BTBlocks = require('../extensions/scratch3_ftrobobt');
...
const builtinExtensions = {
    ...
    ftxt: Scratch3TxtBlocks,
    ftbtsmart: Scratch3BTBlocks,
